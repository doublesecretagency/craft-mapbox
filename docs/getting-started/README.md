---
description: Follow these instructions to set up the Mapbox plugin for Craft CMS. This simple step-by-step guide shows how to get started.
---
...
">
    ...
    <div>
        <strong style="font-size:17px">Mapbox</strong>
        <div style="font-size:15px; margin-top:9px;">Maps in minutes. Powered by the Mapbox API.</div>
